...
<div id="main-content" class="group"> <!--wraps the stuff in the white - left sidebar, center, right sidebar -->
     ...
     <aside>
        ...
        <ul>
            ...
            <li><a href="http://mckenziepta.com/?page_id=535" class="primary"><img src="images/directory_icon.png" width="30" align="left" class="icon" border="0" />PTA Membership and Directory</a></li>
                <p class="descr">Join the PTA and get your student directory today.</p>
                
                
            <li><a href="http://mckenziepta.com/?page_id=486" class="primary"><img src="images/grocerydollars.png" class="icon" width="30"  height="26" align="left" border="0"  />
                    Grocery Dollars</a></li>
                <p class="descr">The easiest way to raise
                money for school. Doesn't cost you a cent!</p>
            	<li><a href="http://mckenziepta.com/?page_id=428" class="primary" ><img src="images/birthdaybooks_icon.png" class="icon" width="30" align="left" border="0" />Birthday Books</a></li>
            ...
            <!--    <li><a href="" class="primary"><img src="images/checklist_icon.png" width="30" align="left" class="icon" border="0" />Order everything at once:</a></li>
                 ...
                 <li><a href="http://jostensyearbooks.com/?REF=A09862419" class="primary" target="_blank"><img src="images/yearbookorder_icon.png" width="30" align="left" class="icon" border="0" />Yearbook Orders</a> </li>
                <p class="descr">New this year:  Order online at Jostens</p>
...
<div id="article-list" class="group">
