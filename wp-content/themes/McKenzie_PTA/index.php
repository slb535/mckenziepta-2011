     ...
     <aside>
        ...
        <ul>
            ...
            <li><a href="http://mckenziepta.com/grocery-dollars/" class="primary"><img src="images/grocerydollars.png" class="icon" width="30"  height="26" align="left" border="0"  />
            	...
            	<li><a href="/pdf/GTKM_2012.pdf" onClick="_gaq.push(['_trackEvent', 'PDFs', 'Downloaded', 'pdf']);" class="primary"><img src="images/pawprint_icon.png" width="30" align="left" class="icon" border="0" />Getting to Know McKenzie</a> </li>
                <p class="descr">Don&rsquo;t miss this handy little book to use during your time at McKenzie.</p>
            ...
            <!--    <li><a href="" class="primary"><img src="images/checklist_icon.png" width="30" align="left" class="icon" border="0" />Order everything at once:</a></li>
                ...
                <p class="descr"><!--Order your yearbook -->Order your yearbook, upload pictures, take classroom photos and more!</p>
